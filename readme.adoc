...
There are some simple Unit tests at:
 https://github.com/Arquisoft/dechat_en1a/tree/master/src/test[src/test].

There are also some
 https://cucumber.io/[Cucumber based tests]
 with a simple user story defined at:
 https://github.com/Arquisoft/dechat_en1a/tree/master/src/test/resources/features[src/test/resources/features].
...
The https://github.com/Arquisoft/dechat_en1a/tree/master/pom.xml[pom.xml] file
